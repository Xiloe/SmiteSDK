...
public:
	...
	unsigned long                                      m_bIsMuted : 1;                                           // 0x0114(0x0004)
	...
	class UGFxObject* GetAS2ClassObject(const struct FString& Path, class UClass* Type);
...
public:
	...
	unsigned long                                      m_bHasCallbacksBound : 1;                                 // 0x00A8(0x0004)
