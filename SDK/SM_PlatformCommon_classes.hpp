...
#include "SM_PlatformCommon_structs.hpp"
...
public:
	...
	bool HandlePlayerCommandInput(const struct FString& FSCommand, class APlayerController* PC);
...
{
public:
	class UPComPerformanceCaptureBase*                 BasePerformanceCapture;                                   // 0x04AC(0x0008) (Transient)
	TEnumAsByte<EPComPerformanceCaptureState>          CurrentCaptureState;                                      // 0x04B4(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x04B5(0x0003) MISSED OFFSET
	TArray<class APComPerformanceCaptureNode*>         NodesToCapture;                                           // 0x04B8(0x0010) (Transient, NeedCtorLink)
	TArray<struct FPComPerformanceCaptureStatsPerNode> StatsPerNode;                                             // 0x04C8(0x0010) (Transient, NeedCtorLink)
...
{
public:
	struct FString                                     ExecCommand;                                              // 0x0260(0x0010) (Edit, NeedCtorLink)
	float                                              DelayBeforeCapture;                                       // 0x0270(0x0004) (Edit)
...
{
public:
	struct FUniqueNetId                                m_LastPendingPartyInviteId;                               // 0x0758(0x0008)
	unsigned long                                      m_bPartySessionJoinInProgress : 1;                        // 0x0760(0x0004)
	unsigned long                                      m_bPartySessionCreateInProgress : 1;                      // 0x0760(0x0004)
	unsigned long                                      m_bPartyDestroyInProgress : 1;                            // 0x0760(0x0004)
	unsigned long                                      m_bQuittingToMainMenu : 1;                                // 0x0760(0x0004) (Transient)
	unsigned long                                      m_bHasAcknowledgedPawn : 1;                               // 0x0760(0x0004) (Transient)
	unsigned long                                      m_bKeepLoggedIn : 1;                                      // 0x0760(0x0004) (Config, GlobalConfig)
	struct Fdword                                      m_dwPendingPartyId;                                       // 0x0764(0x0004)
	int                                                m_nMaxPartyPublicConnections;                             // 0x0768(0x0004) (Config)
	struct FOnlineGameSearchResult                     m_PendingInviteResult;                                    // 0x076C(0x0010)
	struct FName                                       PartySessionName;                                         // 0x077C(0x0008) (Const)
	struct FName                                       GameSessionName;                                          // 0x0784(0x0008) (Const)
	struct Fdword                                      m_dwLastLoginPortalId;                                    // 0x078C(0x0004) (Config, GlobalConfig)
	struct Fdword                                      m_dwLastLoginAccountId;                                   // 0x0790(0x0004) (Config, GlobalConfig)
	struct FString                                     m_sLastLoginAccessToken;                                  // 0x0794(0x0010) (Config, GlobalConfig, NeedCtorLink)
	struct FString                                     m_sLastLoginAccessTokenExpiration;                        // 0x07A4(0x0010) (Config, GlobalConfig, NeedCtorLink)
...
public:
	...
	unsigned long                                      c_bDirty : 1;                                             // 0x031C(0x0004)
	unsigned long                                      c_bUseServerBindings : 1;                                 // 0x031C(0x0004) (Config)
	unsigned long                                      c_bJumpEnabled : 1;                                       // 0x031C(0x0004) (Config)
	unsigned long                                      m_bAllowSaveServerBindings : 1;                           // 0x031C(0x0004)
	struct FString                                     c_sCurrentProfile;                                        // 0x0320(0x0010) (Config, NeedCtorLink)
	int                                                m_nKeybindConfigSet;                                      // 0x0330(0x0004)
	float                                              m_nMinLookSensitivity;                                    // 0x0334(0x0004)
	float                                              m_nMaxLookSensitivity;                                    // 0x0338(0x0004)
	int                                                m_RecCastMode;                                            // 0x033C(0x0004)
	...
	void UnbindCommandAllExtended(const struct FString& Command, bool bStoreToServer);
	void UnbindCommandAll(const struct FString& Command);
	void UnbindCommandFromServer(const struct FString& Command);
	void UnbindKey(struct FName* BindName);
	void SetCommandBind(const struct FString& Command, int nAlternate, const struct FString& ExtendedBinding, bool bStoreToServer, bool bStoreToINI);
	void SetCommandBindFromServer(const struct FString& Command, int nAlternate, const struct FString& ExtendedBinding);
	void SetBindFromServer(const struct FString& BindName, const struct FString& Command);
	void STATIC_SetBind(const struct FString& Command, struct FName* BindName);
	...
	struct FKeyBind GetBindFromCommand(const struct FString& Cmd, int nAlternate);
	int GetBindExtended(const struct FString& Str, bool bExactMatch, struct FKeyBind* Bind);
	struct FString GetStorageStringForCommand(const struct FString& Command);
	void InitKeyBindingsMap();
	void ReadBindings();
	void StoreBinding(const struct FString& BindName, const struct FString& Command, const struct FString& OldCommand);
...
{
public:
	class UPComMusicThemePlayer*                       m_MusicThemePlayer;                                       // 0x02C8(0x0008)
	class UClass*                                      m_MusicThemePlayerClass;                                  // 0x02D0(0x0008)
	struct FString                                     m_MusicThemePlayerClassName;                              // 0x02D8(0x0010) (Config, GlobalConfig, NeedCtorLink)
...
{
public:
	struct FString                                     VideoURL;                                                 // 0x0260(0x0010) (Edit, NeedCtorLink)
	int                                                Width;                                                    // 0x0270(0x0004) (Edit)
	int                                                Height;                                                   // 0x0274(0x0004) (Edit)
	float                                              Volume;                                                   // 0x0278(0x0004) (Edit)
	unsigned long                                      bAutoResize : 1;                                          // 0x027C(0x0004) (Edit)
	unsigned long                                      bConstrainAspectRatio : 1;                                // 0x027C(0x0004) (Edit)
	unsigned long                                      bDebugRender : 1;                                         // 0x027C(0x0004) (Edit)
	unsigned long                                      bVideoFinished : 1;                                       // 0x027C(0x0004) (Transient)
	unsigned long                                      bOnVideoFinishedIssued : 1;                               // 0x027C(0x0004) (Transient)
	unsigned long                                      bHasMinorStreamingProblem : 1;                            // 0x027C(0x0004) (Transient)
	float                                              ConstrainedAspectRatio;                                   // 0x0280(0x0004) (Edit)
	struct FPointer                                    Resource;                                                 // 0x0284(0x0008) (Native, Transient)
	class UTextureRenderTarget2D*                      RenderTargetToUse;                                        // 0x028C(0x0008) (Transient)
	class UTextureRenderTarget2D*                      TextureCopyForStreamingProblem;                           // 0x0294(0x0008) (Transient)
	float                                              TimeSinceMinorStreamingProblem;                           // 0x029C(0x0004) (Transient)
	class UMaterial*                                   StreamingProblemMaterial;                                 // 0x02A0(0x0008) (Transient)
	TEnumAsByte<EPComVideoPlayerError>                 CurrentErrorState;                                        // 0x02A8(0x0001) (Transient)
	TEnumAsByte<EPComVideoPlayerError>                 RenderThreadErrorState;                                   // 0x02A9(0x0001) (Transient)
	unsigned char                                      UnknownData00[0x2];                                       // 0x02AA(0x0002) MISSED OFFSET
	class UTexture2D*                                  BlackTexture;                                             // 0x02AC(0x0008) (Transient)
	struct FScriptDelegate                             __OnVideoFinished__Delegate;                              // 0x02B4(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x4];                                       // 0x02B4(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnVideoError__Delegate;                                 // 0x02C4(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x4];                                       // 0x02C4(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	struct FName                                       m_ReplicatedMusicEvent;                                   // 0x0260(0x0008) (Net)
