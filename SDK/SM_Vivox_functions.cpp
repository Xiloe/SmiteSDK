...
#include "SM_Vivox_parameters.hpp"
...
// (Final, Iterator, Net, NetReliable, Operator, Static, HasOptionalParms)
// Parameters:
// bool                           bIsActive                      (Parm)
...
// (Iterator, PreOperator, Singular, NetReliable, Simulated, Native, Event, Static)
...
// (Latent, Simulated, Exec, Native, Event, Public)
// Parameters:
...
// (Defined, Simulated, Exec, Native, Event, Public)
// Parameters:
// int                            ChannelJoinCount               (Parm)
