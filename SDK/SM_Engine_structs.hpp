...
enum class EStunType : uint8_t
{
	...
	STUN_TYPE_CHARMED              = 9,
	STUN_TYPE_MADNESS              = 10,
	STUN_TYPE_FEARED               = 11,
	STUN_TYPE_PANICKED             = 12,
	STUN_TYPE_BLINDED              = 13,
	STUN_TYPE_MAX                  = 14
};
...
enum class ESoundClassName : uint8_t
{
	...
	voiceingame                    = 22,
	VoiceNarrator                  = 23,
	voicenarratornoducking         = 24,
	VoiceNarratorTutorial          = 25,
	ESoundClassName_MAX            = 26
};
...
// Enum Engine.SoundNode.ERtpcType
enum class ERtpcType : uint8_t
{
	Rtpc_Float                     = 0,
	Rtpc_Bool                      = 1,
	Rtpc_Int                       = 2,
...
struct FImpactInfo
{
	...
	float                                              PercIncreasedDamage;                                      // 0x0064(0x0004) (AlwaysInit)
	class UObject*                                     DeviceModeReference;                                      // 0x0068(0x0008) (AlwaysInit)
	unsigned long                                      bDirectHit : 1;                                           // 0x0070(0x0004) (AlwaysInit)
	unsigned char                                      nFiringInstance;                                          // 0x0074(0x0001) (AlwaysInit)
};
...
struct FParticleChannelContainer
{
	...
	unsigned long                                      TaskForce1 : 1;                                           // 0x0000(0x0004) (Edit)
	unsigned long                                      TaskForce2 : 1;                                           // 0x0000(0x0004) (Edit)
...
{
	struct FString                                     VariableName;                                             // 0x0000(0x0010) (Edit, NeedCtorLink)
	TEnumAsByte<ERtpcType>                             VariableType;                                             // 0x0010(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	TScriptInterface<class URtpcOutput>                Curve;                                                    // 0x0014(0x0010) (Edit)
};
...
struct FSoundClassProperties
{
	...
	class USoundCue*                                   ParentSoundCue;                                           // 0x0020(0x0008) (Edit)
	struct FName                                       m_nmSoundMode;                                            // 0x0028(0x0008) (Edit)
	float                                              m_fNonLocalPriorityBoost;                                 // 0x0030(0x0004) (Edit)
	float                                              m_fLocalPriorityBoost;                                    // 0x0034(0x0004) (Edit)
};
...
{
	int                                                CachedKey;                                                // 0x0000(0x0004) (Transient)
	struct FVector                                     Location;                                                 // 0x0004(0x000C) (Transient)
};
...
struct FOnlineProfile
{
	...
	TEnumAsByte<EOnlineFriendState>                    PresenceState;                                            // 0x0058(0x0001)
};
