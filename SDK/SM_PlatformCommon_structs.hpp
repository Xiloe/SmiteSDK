...
{
	struct FString                                     kbCommand;                                                // 0x0000(0x0010) (AlwaysInit, NeedCtorLink)
	int                                                propId;                                                   // 0x0010(0x0004)
};
...
struct FCombatMessageInfo
{
	...
	TEnumAsByte<ECMTargetType>                         eTargetType;                                              // 0x0014(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0015(0x0003) MISSED OFFSET
	int                                                nAmount1;                                                 // 0x0018(0x0004)
	int                                                nAmount2;                                                 // 0x001C(0x0004)
	int                                                nSourceItemId;                                            // 0x0020(0x0004)
	int                                                nDamageTypeId;                                            // 0x0024(0x0004)
	int                                                nLocationId;                                              // 0x0028(0x0004)
	int                                                nEventIndex;                                              // 0x002C(0x0004)
	int                                                nLocationX;                                               // 0x0030(0x0004)
	int                                                nLocationY;                                               // 0x0034(0x0004)
};
