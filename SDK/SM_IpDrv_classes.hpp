...
{
public:
	TEnumAsByte<ELinkMode>                             LinkMode;                                                 // 0x0260(0x0001)
	TEnumAsByte<ELineMode>                             InLineMode;                                               // 0x0261(0x0001)
	TEnumAsByte<ELineMode>                             OutLineMode;                                              // 0x0262(0x0001)
	TEnumAsByte<EReceiveMode>                          ReceiveMode;                                              // 0x0263(0x0001)
	struct FPointer                                    Socket;                                                   // 0x0264(0x0008) (Const)
	int                                                Port;                                                     // 0x026C(0x0004) (Const)
	struct FPointer                                    RemoteSocket;                                             // 0x0270(0x0008) (Const)
	struct FPointer                                    PrivateResolveInfo;                                       // 0x0278(0x0008) (Const, Native)
	int                                                DataPending;                                              // 0x0280(0x0004) (Const)
...
{
public:
	TEnumAsByte<ELinkState>                            LinkState;                                                // 0x0284(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0285(0x0003) MISSED OFFSET
	struct FIpAddr                                     RemoteAddr;                                               // 0x0288(0x0014)
	class UClass*                                      AcceptClass;                                              // 0x029C(0x0008)
	TArray<unsigned char>                              SendFIFO;                                                 // 0x02A4(0x0010) (Const, NeedCtorLink)
	struct FString                                     RecvBuf;                                                  // 0x02B4(0x0010) (Const, NeedCtorLink)
	...
	bool IsConnected();
	bool Close();
	bool STATIC_Open(const struct FIpAddr& Addr);
	bool Listen();
...
{
public:
	struct FPointer                                    VoiceEngine;                                              // 0x0244(0x0008) (Const, Native, Transient)
	int                                                MaxLocalTalkers;                                          // 0x024C(0x0004) (Config)
	int                                                MaxRemoteTalkers;                                         // 0x0250(0x0004) (Config)
	unsigned long                                      bIsUsingSpeechRecognition : 1;                            // 0x0254(0x0004) (Config)
	class UOnlineGameInterfaceImpl*                    GameInterfaceImpl;                                        // 0x0258(0x0008)
	class UOnlineAuthInterfaceImpl*                    AuthInterfaceImpl;                                        // 0x0260(0x0008)
...
// 0x01CC (0x0490 - 0x02C4)
class AWebServer : public ATcpLink
{
public:
	struct FString                                     ServerName;                                               // 0x02C4(0x0010) (Config, NeedCtorLink)
	struct FString                                     Applications[0xA];                                        // 0x02D4(0x0010) (Config, NeedCtorLink)
	struct FString                                     ApplicationPaths[0xA];                                    // 0x0374(0x0010) (Config, NeedCtorLink)
	unsigned long                                      bEnabled : 1;                                             // 0x0414(0x0004) (Config)
	int                                                ListenPort;                                               // 0x0418(0x0004) (Config)
	int                                                MaxConnections;                                           // 0x041C(0x0004) (Config)
	int                                                DefaultApplication;                                       // 0x0420(0x0004) (Config)
	int                                                ExpirationSeconds;                                        // 0x0424(0x0004) (Config)
	struct FString                                     ServerURL;                                                // 0x0428(0x0010) (NeedCtorLink)
	class UWebApplication*                             ApplicationObjects[0xA];                                  // 0x0438(0x0008)
	int                                                ConnectionCount;                                          // 0x0488(0x0004)
	int                                                ConnID;                                                   // 0x048C(0x0004)
...
{
public:
	class AWebServer*                                  WebServer;                                                // 0x02C4(0x0008)
	struct FString                                     ReceivedData;                                             // 0x02CC(0x0010) (NeedCtorLink)
	class UWebRequest*                                 Request;                                                  // 0x02DC(0x0008)
	class UWebResponse*                                Response;                                                 // 0x02E4(0x0008)
	class UWebApplication*                             Application;                                              // 0x02EC(0x0008)
	unsigned long                                      bDelayCleanup : 1;                                        // 0x02F4(0x0004)
	int                                                RawBytesExpecting;                                        // 0x02F8(0x0004)
	int                                                MaxValueLength;                                           // 0x02FC(0x0004) (Config)
	int                                                MaxLineLength;                                            // 0x0300(0x0004) (Config)
	int                                                ConnID;                                                   // 0x0304(0x0004)
