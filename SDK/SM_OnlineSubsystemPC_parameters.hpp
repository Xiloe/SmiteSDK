...
#include "SM_OnlineSubsystemPC_classes.hpp"
...
struct UOnlineSubsystemPC_CanPlayOnlineWithUsersByUniqueNetIds_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
...
struct UOnlineSubsystemPC_CanPlayOnlineWithUsers_Params
{
	unsigned char                                      LocalUserNum;                                             // (Parm)
